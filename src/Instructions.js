...
const Instructions = () =>
  instructions.map((instruction, index) => (
    <div className="grid grid-flow-col auto-cols-auto gap-4 justify-start">
      <div className="rounded-md w-9 h-9 bg-yellow-500 grid place-items-center font-serif font-bold text-xl text-white leading-none">
        <span className="relative -top-1">{index + 1}</span>
      </div>
